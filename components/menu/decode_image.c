...
extern const uint8_t image_jpg_start[]   asm("_binary_face1_jpg_start");
extern const uint8_t image_jpg_end[]     asm("_binary_face1_jpg_end");
#endif

#ifdef CONFIG_LCD_FACE_2
extern const uint8_t image_jpg_start[]   asm("_binary_face2_jpg_start");
extern const uint8_t image_jpg_end[]     asm("_binary_face2_jpg_end");
#endif
